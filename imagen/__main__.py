...
def main():
    ...
    parse_recons.add_argument(
        "--with", dest="style", type=str, required=True, help="Image for inspiration."
    )
    parse_recons.add_argument(
        "--iterations", type=int, default=4, help="Number of iterations."
    )
    ...
    parse_synthz.add_argument(
        "--iterations", type=int, default=8, help="Number of iterations."
    )
    parse_synthz.add_argument(
        "--octaves", type=int, default=5, help="Number of octaves."
    )
